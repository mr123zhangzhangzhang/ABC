...
class TinyViTBlock(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            window_size (int, optional): Window size for attention. Default is hra.
...
class TinyViT(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            window_sizes (List[int], optional): List of window sizes for each layer. Defaults to [hra, hra, 14, hra].
