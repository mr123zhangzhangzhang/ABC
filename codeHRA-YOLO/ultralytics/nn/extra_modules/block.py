...
__all__ = ['DyHeadBlock', 'C3_DWR', 'C2f_DWR',
           ]
...
class DWREMA(nn.Module):
    ...
    def forward(self, x):
        ...
        x_out = self.attention(x_out) + x
        return x_out




class C2f_DWREMA(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(DWREMA(self.c) for _ in range(n))
